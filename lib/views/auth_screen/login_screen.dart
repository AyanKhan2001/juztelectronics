...
import 'package:juztelectronics/views/auth_screen/signup_screen.dart';
                   ...
                   children: [
                     ...
                     controller.isloading.value ? const CircularProgressIndicator(
                       valueColor: AlwaysStoppedAnimation(lightGreen),
                         ...
                         : ourButton(color: blue3, title: login,textColor: whiteColor, onPress: ()async{
                     ...
                     5.heightBox,
                     ourButton(color:blue2, title: signup,textColor: whiteColor, onPress: (){
